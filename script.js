...
function askUser(){
  var numberMiles = Number(prompt("Number of mile you drive a year on estimate of 1st car?"));
...
function askUser1(){
  var numberMiles = Number(prompt("Number of mile you drive a year on estimate of 2nd car?"));
  var gasPrice = Number(prompt("Whats the current price of gas?"));
...
function askUser2(){
  var numberMiles = Number(prompt("Number of mile you drive a year on estimate of 3rd car ?"));
  var gasPrice = Number(prompt("Whats the current price of gas?"));
...
function askUser3(){
  var numberMiles = Number(prompt("Number of mile you drive a year on estimate of 4th car ?"));
  var gasPrice = Number(prompt("Whats the current price of gas?"));
